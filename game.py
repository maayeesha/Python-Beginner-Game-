...
#player
playerImg = pygame.image.load('social.png')
playerX = 30
playerY = 480
playerX_change = 0
#enemy
...
#bullet
bulletImg = pygame.image.load('signs.png')
bulletX = 0
bulletY = 480
bulletX_change = 0
bulletY_change = 10
...
while running :
    ...
    for event in pygame.event.get() :
        if event.type == pygame.QUIT :
            running = False
    # If keystroke is pressed check whether it's right
        if event.type == pygame.KEYDOWN:
            ...
            if event.key == pygame.K_SPACE:
                if bullet_state is "ready" :
                    ...
                    bulletSound.play()
                    #get the current x coordinate of the doctor
                    bulletX = playerX
